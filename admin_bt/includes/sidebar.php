<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">TAPQ</div>
    </a>
    ...
    <li class="nav-item  <?php
                            if (strpos($_SERVER["PHP_SELF"], "courses.php") || strpos($_SERVER["PHP_SELF"], "404.php") || strpos($_SERVER["PHP_SELF"], "blank.php") || strpos($_SERVER["PHP_SELF"], "edit_course.php") || strpos($_SERVER["PHP_SELF"], "new_course.php") || strpos($_SERVER["PHP_SELF"], "new_exam.php") || strpos($_SERVER["PHP_SELF"], "admins.php")) {
                                echo 'active';
                            }
                            ?>">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">CRUD pages:</h6>
